...
réponse ("Porto", "Lisbonne", "Faro", "2")

print ("8- Quelle est la capitale du Brésil ?")
réponse ("Brasilia", "Sao paulo", "Rio de janeiro", "1")
