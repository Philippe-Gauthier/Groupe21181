...
#options 1_2
textmartinemalchance = "Vous lui dites de faire attention cette semaine, car selon le positionnement de l'étoile vega elle sera malchanceuse jusqu'a la fin de la semaine. Martine vous demande s'il y a quelquechose qu'elle pourrait faire pour se protèger contre sa malchance.  Que lui proposez-vous?"
...
#--2e couche option 1
textmartine = "Martine entre dans votre tente, c'est une femme un peu plus agée que vous, mais pas de beaucoup, c'est votre cliente la plus loyale. Elle vous demande de lui dire sa chance pour la semaine.    Quelle sera sa chance?"
...
#options 2_2_1
textdevinamour_1 = "Vous lui dites qu'il va rencontrer tres bientot l'amour de sa vie, vous le voyez clairement dans votre boule de crystale (brisée, mais vous ne mentionnez pas cela). Il vous supplie de lui en dire plus.  Quel est son futur amoureux?"
devinamour_11 = "Good ending"
devinamour_12 = "Bad ending"
devinamour_13 = "Depressing ending"

devinamour_1 = [textdevinamour_1, devinamour_11, devinamour_12, devinamour_13]

#fin option 2_2_2
textdevinpasamour = "Vous lui dites qu'il n'aura tristement pas la chance de vivre l'amour dans sa vie, mais c'est l'opportunité pour lui de se consacrer a d'autres passions, telles que le pickle ball professionnel. Vous voyez Devin s'affaisser un peu, puis il se leve, et quitte. Vous croyez entendre des pleurs venant de l'exterieur de votre tente. Vous realisez alors qu'il ne vous a pas payé, vous aviez besoin de l'argent pour payer votre spotify premium, vous tombez donc en depression nerveuse."
devinpasamour = [textdevinpasamour]

#options 2_2_3
textdevindevier = "Vous ne pensiez pas avoir besoin d'en dire plus, il vous a pris au dépourvu, et vous ne pouveaz pas vous fier sur votre boule de crystal. vous décidez donc de sortir l'artillerie lourde. Vous dites a Devin d'attendre quelques secondes pour que vous puissiez aller chercher votre matériel.     Quel item prennez-vous?"
...
#options 2_3_1
textdevindevin = "Il vous dit que oui il s'appelle Devin.   Vous le regardez dans les yeux et lui dites:"
...
#---3e couche options 2_1, 2_2, 2_3
#option 2_1
textdevinjeux = "Vous lui dites que l'amour est difficile a lire en ces temps incertains (l'ombre de vénus vous bloque la vue) mais que vous voyez clairement le futur des jeux videos. Soudainement tout excité, Devin vous demande avec passion lequel entre trois jeux sortira en premier.   Quel jeu sortira en premier?"
...
#option 2_2
textdevinamour = "Vous lui dites que le futur en termes de sorties de jeux est assez flou ce matin (mercure retrograde) mais vous voyez clairement son futur amoureux. Il vous demande de lui en dire plus.     Que lui dites-vous?"
devinamour1 = "Amour"
...
#option 2_3
textdevinnom = "Vous l'interrompez et lui demandez d'ou vient son nom. Vous pensiez que seuls les devins de grandes familles pouvaient s'appeller Devin, mais vous trouvez que ce jeune homme n'a vraiment pas l'air du genre 'famille riche et connue avec des pouvoirs divinatoires'.     Vous lui demandez si:"
...
#---3e couche options 3_1, 3_2, 3_3
#option 3_1
textchienwraf = "Vous pensez avoir bien répondu, mais le chien se met a grogner Il vous demande en jappant: 'WAF WOUF WOUF WIF WRAF??'  Que faites-vous?"
...
#--2e couche, option 3
textchien = "Le chien entre dans votre tente, vous êtes un peu confuse, vous lui dites de s'asseoir (vous êtes fluente en chien, mais ca fait un bail alors vous êtes un peu rouillée). Le chien s'asseoit, et il vous demande: 'Wouf wouf wrouf warf waf wif rrwar wuif?'  Que lui répondez-vous?"
...
text1 = "Vous arrivez a votre tente de divination au milieu d'un petit centre d'achat, juste a coté du dollarama (pour attirer toutes les superstitieuses qui magasinnent là bas). Vous avez une petite file qui vous attend devant votre tente, deux personnes et un chien (?).    Qui faites-vous entrer en premier?"
...
def start_game():
    ...
    while True:
        ...
        if start_confirmation == "y":
            print_par_lettre(".....") #fonction ici utilisée pour le "loading"
            break
...
def detecteur_fin(niveau_selectionne):
    ...
    while True:
        ...
        if nombre_choix > 1:
            ...
            while True:
                print(jeu_fin)
                debuter_confirmation = input("\nVoulez vous retourner au début de la journée? (y/n) ")
                if debuter_confirmation == "y":
                    print(choix_retour)
                    time.sleep(1)
                    print_par_lettre(".....")
                    time.sleep(0.5)
