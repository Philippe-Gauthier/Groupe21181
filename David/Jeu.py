...
'''
Titre du projet 1 : L'ascension d'une étoile
...
devenir footballeur professionnel.Les recruteurs t'ont remarqué, les portes s'ouvrent,\n \
et ton destin est sur le point de basculer.Mais avant tout, qui es-tu vraiment ?"

Question_1 = "Quelle est ton poste sur le terrain"  
Question_1_choix_1 = "Attaquant : Tu es un finisseur né. Vitesse, instinct, sang-froid devant le but.\n \
Tu vis pour marquer et faire exploser les stades."
...
travail, précision, leadership. Ses coups francs légendaires et son professionnalisme \n \
t'ont montré le chemin vers l'excellence."
...
#Message pour indiquer la fin du programme
fin = "C'est la fin de votre l'histoire."
...
if choix == 1:
    choix = int(input(formater_question(Question_2, Question_2_choix_1,Question_2_choix_2, aucun)))
    if choix == 1:
        ...
        choix = (int(input(formater_question(Question_3, Question_3_choix_3, Question_3_choix_4, aucun))))
        if choix == 1:
    ...
    choix = (int(input(formater_question(Question_2, Question_2_choix_3,Question_2_choix_4, aucun))))
    if choix == 1:
        choix = (int(input(formater_question(Question_3, Question_3_choix_5, Question_3_choix_6, aucun))))
        if choix == 1:
        ...
        choix = int(int(input(formater_question(Question_3, Question_3_choix_7, Question_3_choix_8, aucun))))
        if choix == 1:
