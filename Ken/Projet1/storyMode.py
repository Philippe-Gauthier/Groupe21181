...
def secret_ending():
    ...
    ENTRÉE : RIEN
    SORTIE : RIEN
    BUT :    FIN SECRÈTE AMUSANTE si l'utilisateur entre 7 comme résultat de dé. Accessible seulement si tu as le dé
    """
...
if controle == 1:
    ...
    "L'agent Carraway baissa les yeux et vit effectivement des mains tremblantes sur la table. Eliot essayait de cacher sa nervosité... Carraway se détestait de ne pas l'avoir remarqué en premier que son collègue, le détective Buchanan. ")
elif violence == 1:
...
if roll_result <= 2:                    #Option pacifique
    ...
    lucidite += 1
    if violence == 1 :
        print_slow("-Allez c'est bon je vais continuer. Dit l'agent Carraway.\nBuchanan gloussa. Il baissa la tête, la secoua de déception, et recula.\n\n ")
...
print_slow("-Est-ce que vous avez deja lu les lettres? Demanda Elliot.\n-Lesquelles? Demanda sèchement Buchanan.\n-Celles qu'on ne montre pas aux journaux.\n\n-De quoi il parle encore?\n\n-Je... je pense savoir ce qu'il essaie de dire. Dit Carraway.\n\n")
...
if simple_choice == "NON":                      #Approche de Fin 4 et 5 car pas supposé
    ...
    if roll_result % 2 == 0:                    #Si pair FIN 4 approche. Questionne tout
        ...
        if roll_result == 4 : 
            ...
            lucidite += 3
            print_slow("\n\n-Quoi? Je ne comprends pas. Où est mon badge?! Je l'avait sur moi en entrant ici! Redonne-le moi, voyou de merde\n\n-Vous n'êtes plus vous-même, détective.\n\nLe détective se tourna pour voir son collègue, qui était silencieux depuis un moment...\n\n")
            roll_result = dice_Check()
            if roll_result % 2 == 0:
                print_slow("Son collègue était bien là. Confus pour toute cette situation.\nMais ne disait aucun mot. ")
            else:
                print_slow("Il n'y avait personne d'autre dans la salle à part lui et le suspect. Il ne se rappelait plus du nom du suspect. Il a sûrement été drogué. Il sortit son arme pour se défendre. " \
                "Arme pointée sur le suspect, il ne résagissait pas plus. C'est alors que Carraway comprit qu'une banane n'était aucunement menacante.\n\n")
            print_slow("Il n'en revenait pas. La salle était devenue blanche. Le miroir n'était plus là. Le suspect se leva et dit : Bon on peut maintenant jeter les rideaux. Ça ne fonctionne pas du tout. Il cria : VOUS POUVEZ ENTRER!.\nÀ peine ces mots dit, " \
            ...
            "ce sera alors pour une autre fois. \n\nCarraway essaya de se débattre. Il était un détective, enfin, il pense. Les infirmiers lui injectèrent un sédatif. Et l'amènèrent dans un couloir blanc, vide. À tout jamais.\n\nFIN.")
        else :
            save_ending5()
    else:                                       #Sinon, FIN 5 (la vraie fin, la vraie de vrai)
        print_slow("-Là vous ne répondez pas aux attentes M. Kramer. Avez-vous, oui ou non vu quelqu'un ou quelque chose de suspect?\n-Vous le savez deja.\n-Quoi?\n-Vous savez qui a commis ces horreurs, mais vous refusez de l'admettre.\n\nBuchanan sorti une cigarette. Il comprit que des aveux se préparaient à sortir. Lesquelles? C'était sans importance. Il ne voulait que la justice." \
        "Chaque expiration de la cigarette de Buchanan faisait tousser Carraway. Il détestait l'odeur.\n\n-Eh bien, quand je me disais que c'était juste un petit crime... Qu'as-tu fait Carraway?\n-Rien, je n'ai rien à voir avec tout ca.\n-Menteur.\n-Et vous, M. Elliot, je vous rapelle que vous êtes le premier suspect dans l'affaire. Alors arrêtez de tourner" \
        "l'investigation vers moi. Tu ne réussiras pas à me manipuler.\n-Ok je vais dire un truc. Oui j'ai vu quelqu'un. Cette personne portait un chapeau assez élégant mais il avait les mains tachés de sang. Je l'ai vu sortir de la ruelle où que le crime a été commis.\n-Alors voila! Enfin des détails! Quoi d'autre?\n-Arrêtez de jouer à l'imbécile avec moi.\n-Je" \
        " vous demande pardon?\n-Vous étiez la, ce soir-là")
