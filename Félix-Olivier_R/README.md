...
### Votre rôle
1. Lorsque vous voyez "-Suite" à la fin d'une ligne de texte, pour continuer et faire apparaître la prochaine, veuillez appuyer sur ENTER. Si cela n'est pas à la fin et il y n'y a plus de texte, ni d'options, attendez simplement, l'histoire est conçue pour se dérouler lentement.
...
3. Si vous entrez une réponse invalide, le programme vous demandera de ré-essayer.
### Entrées
 - Les numéro assignés aux choix entrées par l'utilisateur.
 - La fonction "continuer" qui permet de donner plus le temps à l'utilisateur. 
### Sorties
